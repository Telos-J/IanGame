        ...
        this.update = function () {
            switch (this.state) {
                case 'follow':
                    ...
                    if (
                        player.getRight() >
                            this.getLeft() - 3 * world.tileWidth &&
                        player.getBottom() >
                            this.getTop() - 3 * world.tileHeight &&
                        player.getLeft() <
                            this.getRight() + 3 * world.tileWidth &&
                        player.getTop() <
                            this.getBottom() + 3 * world.tileHeight
                    ) {
                        this.state = 'shoot'
                        this.pounceBegin = 30
                    }
    ...
    const Camera = function () {
        ...
        this.setCamera = function () {
            ...
            if (player.getBottom() > this.y + this.width - this.blindspot)
                this.y += player.speed
            if (player.getLeft() < this.x + this.blindspot)
                this.x -= player.speed
            if (player.getTop() < this.y + this.blindspot)
                this.y -= player.speed
